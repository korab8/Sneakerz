package com.km.sneakerz.custom.view
 ...
 * Credit to https://github.com/mike5v/viewmore-textview
 */


private const val TAG = "ViewMoreTV"
...
class ViewMoreTextView @JvmOverloads constructor(
    ...
    private fun setForeground(isExpanded: Boolean) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            Log.d(TAG, "Android Version lower than M")
        }
